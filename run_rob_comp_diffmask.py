...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model",
        type=str,
        default="checkpoints/comp_roberta-base",
    )
    parser.add_argument("--epochs", type=int, default=1)
    parser.add_argument(
        "--train_filename",
        type=str,
        default="./features/train_comp_simbert_30",
    )
    parser.add_argument(
        "--val_filename",
        type=str,
        default="./features/dev_comp_simbert_30",
    )
    ...
    parser.add_argument("--eps_valid", type=float, default=0.5)
    ...
    trainer = pl.Trainer(
        ...
        checkpoint_callback=pl.callbacks.ModelCheckpoint(
            filepath=os.path.join(
                "outputs",
                "comp-roberta-{}-layer_pred={}".format(hparams.gate, hparams.layer_pred),
